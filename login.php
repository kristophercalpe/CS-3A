...
<body>
	<div class="logform">
			...
			<div class="input-group">
				<input type="email" style="font-family:Sansita" placeholder="Email" name="email" required>
			</div>
			<div class="input-group">
				<input type="password" style="font-family:Sansita" placeholder="Password" name="password" required>
			</div>
			<div class="input-group">
